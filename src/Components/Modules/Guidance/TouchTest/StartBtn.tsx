...
export default function StartBtn() {
  return (
    <div className="w-full h-[80px] flex flex-row justify-center items-center gap-4 p-3 bg-white shadow-md rounded-2xl">
      <div className="w-full h-full flex flex-row justify-end items-center gap-x-4 bg-[#EBF8FC] rounded-2xl">
        ...
        <button className="h-full p-4 bg-blue-500 shadow-md rounded-xl flex justify-center items-center gap-3">
